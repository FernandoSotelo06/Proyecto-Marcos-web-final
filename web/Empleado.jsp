                    ...
                    <tbody>
                        <c:forEach var="em" items="${empleados}">
                            <tr>
                                ...
                                <td>${em.getUser()}</td>
                                <td>
                                    <a class="btn-info" style="border-radius: 5px; margin: 10px;  text-decoration: none" href="Controlador?menu=Empleado&accion=Editar&id=${em.getId()}">Editar</a>
                                    <a class="btn-secondary" style="border-radius: 5px; margin: 10px; text-decoration: none" href="Controlador?menu=Empleado&accion=Delete&id=${em.getId()}">Delete</a>
                                </td>
                            </tr>                       
                        </c:forEach>
